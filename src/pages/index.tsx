...
import image_kim from "../assets/images/image_kim.jpg";
  ...
  return (
    <Layout>
      ...
      <section className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <img src={image_kim} alt="Jarupong Thongmark" className="h-full w-full object-cover" />
          </div>

          <p className="text-right col-span-2">
          ปัจจุบันคาเฟ่ และห้องสมุดนี้โดนยึดแล้ว ในตอนนี้ นายจารุพงศ์ ทองมาก รหัส 65070031 เป็นเจ้าของแล้วจ้าซึ่งมีบริการหนังสือให้อ่านมากมายโดยมีหนังสือหลากลายให้ได้เลือกอ่าน
          แถมยังมีเครื่องดื่มกาแฟพร้อมให้บริการ มีเมนูหลากหลายให้เลือกในคาเฟ่แห่งนี้นะ
        </p>
        </div>
      </section>
